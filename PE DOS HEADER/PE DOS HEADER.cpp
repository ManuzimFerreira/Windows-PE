...
int main()
{
	auto fileBytes = ReadBytesFromFile(R"(C:\Users\manuz\source\repos\Injector de DLL\x64\Debug\Injector de DLL.exe)");
	...
	cout << "PE Header: 0x" << hex << PeDosHeader->e_lfanew << endl;



	system("pause");

	// you can put here all you wanna know about the PE DOS HEADER; 
}
